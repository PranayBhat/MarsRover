...
document.getElementById("firstRover").style.display="inline-block";}

canvas = document.getElementById('firstRover');
...
function up() { if(rover_y >=0) { rover_y = rover_y - 10; console.log("When up arrow is pressed, x = " + rover_x + " | y = " +rover_y);
uploadBackground(); 
uploadrover();
}}
function down()
 ...
 function left() { if(rover_x >= 0 ) 
    ...
    function right()
     { if(rover_x <= 410)
         ...
         document.getElementById("firstRover").style.display="none";}